    ...
    Column(modifier=Modifier.fillMaxSize()) {
        ...
        Row(modifier=Modifier
            ...
            Column(modifier= Modifier
                ...
                TextField(value = inputText.value, shape = RoundedCornerShape(10.dp), onValueChange ={
                    inputText.value=it
                } )
                TextField(value = inputText1.value, shape = RoundedCornerShape(10.dp), onValueChange ={
                    inputText1.value=it
                } )
            }
        }
